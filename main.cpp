 ...
 *
 *
 Some of the processes run faster than others because of the amount
 of numbers passed in as the argument and also the spread of the work
 is a factor in the running time
 *
 *
 */
