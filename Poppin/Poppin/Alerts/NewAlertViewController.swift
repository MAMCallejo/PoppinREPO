...
final class NewAlertViewController: UIViewController {
    ...
    lazy private var alertTitle: String = NewAlertViewController.defaultAlertTitle
    lazy private var alertMessage: String = NewAlertViewController.defaultAlertMessage
