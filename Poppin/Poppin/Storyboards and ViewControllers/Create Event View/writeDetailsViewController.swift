...
class writeDetailsViewController: UIViewController, UITextViewDelegate {
    ...
    lazy var whiteView: UIView = {
        ...
        whiteView.backgroundColor = .white
           whiteView.addShadowAndRoundCorners(cornerRadius: 20, topRightMask: false, topLeftMask: false)
           return whiteView
       }()
    ...
    lazy var purpleTab: UIView = {
       let purpleTab = UIView()
        //purpleTab.backgroundColor = .newDarkGold
        purpleTab.addShadowAndRoundCorners(cornerRadius: 20, bottomRightMask: false, bottomLeftMask: false)
        return purpleTab
    }()
    ...
    override func viewDidLoad() {
        ...
        whiteView.widthAnchor.constraint(equalToConstant: view.bounds.width * 0.75).isActive = true
        ...
        view.addSubview(detailsTextField)
             ...
             detailsTextField.widthAnchor.constraint(equalToConstant: view.bounds.width * 0.75).isActive = true
        ...
        purpleTab.heightAnchor.constraint(equalToConstant: view.bounds.height * 0.06).isActive = true
        purpleTab.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        purpleTab.bottomAnchor.constraint(equalTo: detailsTextField.topAnchor).isActive = true
        ...
        backButton.leadingAnchor.constraint(equalTo: purpleTab.leadingAnchor, constant: view.bounds.width * 0.01).isActive = true
        ...
        checkButton.trailingAnchor.constraint(equalTo: purpleTab.trailingAnchor, constant: -view.bounds.width * 0.01).isActive = true
    ...
    @objc func goBack() {
        ...
        let alertVC = NewAlertViewController(alertTitle: nil, alertMessage: "Are you sure you wish to discard?", alertButtons: [button1, button2])
...
//        }
    ...
    func textViewDidBeginEditing (_ textView: UITextView) {
        if  detailsTextField.text == "Add Title" && detailsTextField.isFirstResponder {
    ...
    func textViewDidEndEditing (_ textView: UITextView) {
        if detailsTextField.text.isEmpty || detailsTextField.text == "" {
            detailsTextField.textColor = .mainDARKPURPLE
            detailsTextField.text = "Add Title"
        }
    }
