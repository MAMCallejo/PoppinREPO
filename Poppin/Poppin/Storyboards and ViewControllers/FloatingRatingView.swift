...
//        didSet {
//            emptyImage = UIImage(named: "categoryButtonNP")
...
//        didSet {
//            fullImage = UIImage(named: "goldButton")
...
//    }
    ...
    @IBInspectable open var type: FloatRatingViewType = .floatRatings
...
//        let alert = UIAlertController(title: "Are you sure of this rating?", message: nil, preferredStyle: .actionSheet)
//        alert.addAction(UIAlertAction(title: "Confirm", style: .default, handler: { _ in
//            // do something
//        }))
//        alert.addAction(UIAlertAction.init(title: "Cancel", style: .cancel, handler: nil))
//        popsicleInfoViewController.view.present(alert, animated: true, completion: nil)
    }
