...
class UserViewController: UIViewController, UINavigationControllerDelegate {
    ...
    lazy var nameLabel: UILabel = {
        ...
        nameLabel.textColor = UIColor.newPurple
        return nameLabel
    }()
    ...
    lazy var usernameLabel: UILabel = {
        ...
        usernameLabel.textColor = UIColor.newPurple
    ...
    lazy var bioLabel: UILabel = {
        ...
        bioLabel.textColor = UIColor.newPurple
    ...
    lazy var followerLabel: UILabel = {
        ...
        followerLabel.textColor = UIColor.newPurple
    ...
    lazy var followerCountButton: UIButton = {
        ...
        followerCountButton.setTitleColor(.newPurple, for: .normal)
    ...
    lazy var followingLabel: UILabel = {
        ...
        followingLabel.textColor = UIColor.newPurple
    ...
    lazy var followingCountButton: UIButton = {
        ...
        followingCountButton.setTitleColor(.newPurple, for: .normal)
    ...
    lazy var backgroundView: UIImageView = {
        let backgroundView = UIImageView(image: UIImage.mainAppBackground)
    ...
    @objc func follow(){
        ...
        if(followButton.titleLabel!.text == "following"){
            ...
            let button2 = AlertButton(alertTitle: "Continue", alertButtonAction: {
                ...
                self.followButton.backgroundColor = .newPurple
            })
            
            let alertVC = NewAlertViewController(alertTitle: "Are you sure you wish to unfollow this user?", alertMessage: "You wish", alertButtons: [button1, button2])
            ...
            followButton.setTitleColor(.newPurple, for: .normal)
