//
//  NewLoginForgotPasswordViewController.swift
//  Poppin
//
...
class NewLoginForgotPasswordViewController: UIViewController {
        ...
        if let email = emailTextField.text, email != "" {
            ...
            Auth.auth().sendPasswordReset(withEmail: email, completion: { [weak self] error in
                ...
                if error != nil {
                    ...
                    let alertVC = NewAlertViewController(alertTitle: "Email Sent!", alertMessage: "We sent an email to " + email + " with a link to reset your password.", alertButtons: [button1])
            ...
            let alertVC = NewAlertViewController(alertTitle: "Something went wrong", alertMessage: "Please try again.", alertButtons: [button1])
...
extension NewLoginForgotPasswordViewController: UITextFieldDelegate {
