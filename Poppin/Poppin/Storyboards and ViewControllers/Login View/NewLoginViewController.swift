...
class NewLoginViewController: UIViewController {
    ...
    @objc private func switchToSignUp(sender: BouncyButton) {
        ...
        if let firstAfterRootVC = navigationController?.viewControllers[1] as? NewSignUpFirstPageViewController {
            ...
            navigationController?.pushViewController(NewSignUpFirstPageViewController(), animated: true)
    ...
    @objc private func switchToPasswordReset(sender: BouncyButton) {
        ...
        present(NewLoginForgotPasswordViewController(), animated: true, completion: nil)
